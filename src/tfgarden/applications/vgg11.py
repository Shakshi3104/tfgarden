...
def VGG11(include_top=True, weights='hasc', input_shape=None, pooling=None, classes=6, classifier_activation='softmax'):
    ...
    x = ConvBlock(1, 64, block_id=1)(inputs)
    x = ConvBlock(1, 128, block_id=2)(x)
    x = ConvBlock(2, 256, block_id=3)(x)
    x = ConvBlock(2, 512, block_id=4)(x)
    x = ConvBlock(2, 512, block_id=5)(x)
